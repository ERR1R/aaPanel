var lan = {
	"get":function(key,args){
		var msgs = {
			...
			"config_edit_ps":"This is {1} primary configuration file, do NOT modify it at will if you do not know configuration rules.",
	...
	"index":{
		...
		"mem_warning":"Currently available physical memory is less than 64M, which may cause MySQL to automatically stop, site 502 and other errors, please try to free the memory!",
		...
		"bind_bt_account_first":"Please bind your BT account first!",
		...
		"update":"Update",
		"find_bug_reward":"Find bugs, get BT coins",
		...
		"update_verison_click":"If you need to update to the beta version, please click",
		...
		"have_new_version":"New panel version available, update?",
		...
		"second_left_of_click":"{1} second(s) left before you can click",
	...
	"config":{
		...
		"config_user_binding":"Binding your BT account",
		"config_user_edit":"Change BT account",
		"binding":"Bind",
		"token_get":"Getting token...",
		"user_bt":"BT username",
		"pass_bt":"BT password",
		"binding_un_msg":"Are you sure to unbind BT account？",
		"binding_un_title":"Unbind",
		"binding_un":"unbind",
		"ssl_close_msg":"Have to use http protocol to access the panel after turning off SSL, continue?",
		"ssl_open_ps":"Warning! This feature requires Advanced Knowledge!",
		"ssl_open_ps_1":"You can only turn it on if you really want to use it and understand this feature!",
		"ssl_open_ps_2":"Panel SSL uses a self-signed certificate, which is NOT trusted by browsers. It is normal if browsers diplay sercurity warnings",
		...
		"open_small_app":"Open the BT panel Mini Program",
		"qrcore_of_small_app":"QR code of Mini Program",
		"scan_qrcore_with_small_app":"Use BT Mini Program to scan the current QR code to bind the panel",
		"return_bind_list":"Return to the panel binding list",
		"read_bind_list":"View binding list",
		"bind_wechat":"Bind WeChat",
		"no_bind_bt_account":"BT account NOT bound",
		...
		"help3":"The API document is here",
	...
	"crontab":{
		...
		"TZZ6":"Saturday",
		"TZZ7":"Sunday",
		"mem_ps":"Free memory of PHP/MySQL/Pure-FTPd/Apache/Nginx, recommended to be executed every midnight!",
		"mem":"Free memory",
		...
		"tips":"Tips",
		"tips_content":"Free memory of PHP/MySQL/Pure-FTPd/Apache/Nginx, recommended to be executed every midnight!",
	...
	"bt":{
		...
		"install_ps":"Recommended to use the following one-click packages, pls choose on demand or in",
		"install_s":"Software Store",
		"install_s1":"choose by yourself, recommended to install LEMP.",
		"install_lnmp":"LNMP(Recommended)",
		"install_type":"Method",
		"install_rpm":"Fast",
		"install_rpm_title":"i.e. rpm, installed in a very short time (5~10 minutes), with performance and stablity a bit lower than compiled",
	...
	"files":{
		...
		"recycle_bin_on":"Turn on recycle bin feature",
		...
		"file_group":"Group",
		"file_act":"Action",
		"get_size":"A total of {1} directories and {2} files, size:",
		"get":"Get",
		"new":"New",
		...
		"ps_swap":"PS: BT default swap virtual memory file",
	...
	"ftp":{
		...
		"add_path_title":"Root directory of user, which will automatically create directory of the same name",
		...
		"stop_confirm":"Do you want to deactive FTP of {1}?",
	...
	"database":{
		...
		"character":"Character",
		"row_num":"Row number",
		"tb_repair":"[Repair] Try to repair the damaged table with the REPAIR command. You can only do a simple repair. If the repair is not successful, consider using the myisamchk tool.",
	...
	"soft":{
		...
		"php_main5":"Install extentions",
		"php_main6":"Disabled functions",
		"php_main7":"Performance optimization",
		...
		"mysql_mem_err":"Server memory is less than 1G. It is not recommended to use MySQL 5.5 or later.</li><li>If the database stops automatically, try to increase swap with Linux Toolbox or increase server memory",
		"concurrency_m":"Custom",
		"concurrency":"Concurrency",
		"concurrency_type":"Concurrency plan",
		"php_fpm_model":"Running mode",
		"php_fpm_ps1":"PHP-FPM mode",
		"php_fpm_ps2":"Max child progresses allowed to create",
		"php_fpm_ps3":"Initial processes (Num of initiatial progresses when server starts)",
		"php_fpm_ps4":"Min idle progresses (Kept progress after killing idle processes)",
		"php_fpm_ps5":"Max idle progresses (Kill idle progresses when reach this value)",
		...
		"mysql_set_err":"ERROR, memory allocation is too high!<p style='color:red;'>Physical memory: {1}MB<br> Maximum memory: {2}MB<br>Possible result: mysqld service unstable, even unable to start!</p>",
		...
		"bt_developer":"The BT developer platform has been launched and we invite outstanding developers from all over the world to join us with low threshold and high income.",
		...
		"save":"Save",
		"php_seesion_tips1":"If your site has high concurrency, using Redis, Memcache can effectively improve the concurrency of PHP",
		...
		"used_memory_rss":"Total system memory currently used by Redis",
		...
		"author":"Author",
		"source":"Source",
		"third_party_apps_tips1":"This is a plugin developed by a third party, BT can not verify its reliability!",
	...
	"site":{
		...
		"default_site_help_1":"All unbound domains and IP will be redirected to the default site when default site is set",
		...
		"to301_help_2":"After cancelling the 301 redirect, you need to clear the browser cache to see the effective results.",
		"bt_ssl":"BT SSL",
		...
		"ssl_help_3":"If you need other SSL, please switch to other SSL certificate tab, paste your KEY and CRT/PEM content, and then save.",
		"ssl_key":"Private key (KEY)",
		"ssl_crt":"Certificate (CRT/PEM)",
		"ssl_close":"Disable SSL",
		"bt_bind_no":"Not bound to BT account, please register and bind. After binding BT account (non-forum account), you can deploy SSL with one click",
		"bt_user":"BT Account",
		"login":"Login",
		"bt_reg":"Register BT account",
		"bt_ssl_help_1":"BT SSL certificate is issued by TrustAsia, requires real name identification",
		"bt_ssl_help_2":"If you have BT account, please log in and bind it",
		"bt_ssl_help_3":"BT SSL applys certificate TrustAsia DV SSL CA - G5. Original price: 1900 RMB/year, but free for aaPanel users!",
		...
		"bt_ssl_help_6":"BT SSL certificate is the free version of TrustAsia DV SSL CA - G5 certificate, which only supports a single domain.",
        ...
        "firewalld_nonactivated_tips": "{1} Firewall is NOT activated yet.<br>Please go to&quot;<a href='/soft' class='btlink'>Software Store > Paid plugins > {2} Firewall</a>&quot;<br>to activate and install it.",
        ...
        "specify_subdir": "Some programs need to specify a secondary directory as the working directory, e.g., ThinkPHP5, Laravel', 'Select your working directory, click Save",
        ...
        "ssl_tips2": "BT SSL applys for the free version of TrustAsia DV SSL CA - G5 certificate, which only supports single domain name application.",
        ...
        "ssl_tips6": "99% of users can easily deploy themselves, if you don't understand, <a class='btlink' href='https://www.bt.cn/yunwei' target='_blank'>BT provides certificate deployment service 50 yuan Once</a>",
        ...
        "dns_check_tips3": "Before using the [BT DNS Cloud Resolution] API, you need to confirm that the domain DNS for which you want to apply for SSL certificate is [Cloud Resolution]",
        ...
        "dns_check_tips5": "Check domain in advance (identify problems in advance and reduce failure rate)",
        ...
        "dns_resolve_tips3": "If you are using the BT Cloud Resolution plugin, Ali Cloud DNS,DNSPod as a DNS, you can set auto-resolution with the DNS API",
        ...
        "redirect_tips1": "Redirect type: indicates that the domain name selected or the path entered will be redirected to the specified URL",
        "redirect_tips2": "The target URL: You can fill in the site to which you need to redirect. The target URL must be a properly accessible URL, or an error will be returned",
        "redirect_tips3": "Redirect mode: use 301 for permanent redirection and 302 for temporary redirection",
        "redirect_tips4": "Reserved URI parameter: indicates whether the URL accessed after redirection has subpaths or parameters, e.g. set access to http://b.com redirected to http://a.com",
        "redirect_tips5": "Keep the URI parameter: http://b.com/1.html ---> http://a.com/1.html",
        "redirect_tips6": "NOT keep the URI parameter: http://b.com/1.html ---> http://a.com",
        ...
        "proxy_tips1": "Proxy directory: when you access this directory, the contents of the target URL will be returned and displayed (advanced features required)",
        "proxy_tips2": "The target URL: you can fill in the site you need to proxy. The target URL must be a properly accessible URL, or an error will be returned",
        "proxy_tips3": "Domain to be sent: add the domain name to the request header and pass it to the proxy server. It is the target URL domain name by default. If not set up properly, the proxy may not function properly",
        "proxy_tips4": "Content replacement: can only be provided when using nginx, you can add up to 3 replaced content, if you do not need to replace, please leave it blank",
        ...
        "access_empty_ref_default": "By default, resources are allowed to be accessed directly, i.e., requests with empty HTTP_REFERER are not restricted",
        ...
        "deploy_success_cret": "Successfully deployed: ",
        "try_renew_cret": "Automatic renewal will be attempted within 1 month to the expiration time",
	...
	"public_backup":{
		...
		"cp_success":"Successfully copied",
		"cp_fail":"Failed to copy, browser is not compatible!",
		"bind_bt_account":"Bind BT account registered on bt official site",
		...
		"cancel":"Cancel",
		"unbind":"Unbind",
		"open_bt_small_app":"Open the BT panel mini program",
		"app_qr_core":"Mini program QR code",
		"scan_qr_core":"Use BT Mini Programs to scan the current QR code and bind to the panel",
		...
		"access_ip_tips":"Multiple IPs separated by commas (,)",
		"db_name":"Database name",
	...
	"login":{
		"qr_core_login":"BT Mini Program QR code login",
		"open":"Open",
	...
	"pythonmamager":{
		...
		"status":"Status",
		"operate":"Operate",
		"py_tips1":"By default, the manager uses the pip to install the module in requirements.txt in the root directory. If there are other modules to be installed, please manually enter the virtual environment to install",
	...
	"linuxsys":{
		...
		"add_swap":"Add Swap",
		"confirm":"Confirm",
		"swap_tips1":"Swap is virtual memory under Linux, set the appropriate swap to increase server stability",
		...
		"mem_disk_tips2":"The memory disk directly mounts part of the physical memory as a disk. Please arrange the mount capacity according to the current server memory usage!",
		"mem_disk_tips3":"After restarting the server or unloading the memory disk, the data saved in the memory disk will be cleared!",
		...
		"deleting":"Deleting...",
		"umount_mem_disk":"Unmount the memory disk",
		"umount_tips1":"After uninstalling the memory disk, the target mount directory will be cleared.</p>Are you sure you want to uninstall the mount directory [{1}]?",
	...
	"mail_sys":{
		...
		"add_user_tips1":"POP service [ ServerAddress：<b>{1}</b> Port：<b>110</b> ]",
		"add_user_tips2":"IMAP service [ ServerAddress：<b>{1}</b> Port：<b>143</b> ]",
		"add_user_tips3":"SMTP service [ ServerAddress：<b>{1}</b> Port：<b>25</b> ]",
